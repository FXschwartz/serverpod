...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('chat', '20260724160035980', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160035980', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_chat', '20260417182349931', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417182349931', "timestamp" = now();
