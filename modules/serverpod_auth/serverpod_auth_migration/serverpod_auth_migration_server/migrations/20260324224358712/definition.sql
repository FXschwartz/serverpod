...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20260324224358712', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260324224358712', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_core', '20260324224353941', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260324224353941', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_idp
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp', '20260324224356317', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260324224356317', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth', '20260324224347429', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260324224347429', "timestamp" = now();
