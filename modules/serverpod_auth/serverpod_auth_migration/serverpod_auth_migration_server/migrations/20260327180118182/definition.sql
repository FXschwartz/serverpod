...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20260327180118182', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260327180118182', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_core', '20260327180113302', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260327180113302', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_idp
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp', '20260327180115662', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260327180115662', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth', '20260327180106169', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260327180106169', "timestamp" = now();
