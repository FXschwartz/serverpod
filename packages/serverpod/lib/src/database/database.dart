...
class Database {
  ...
  /// Deletes all rows matching the [where] expression and returns the
  /// deleted rows.
  ///
  /// Use [where] to specify which items to delete.
  ///
  /// To specify the order of the returned deleted items use [orderBy] or
  /// [orderByList] when sorting by multiple columns.
  @internal
