...
import 'reactive_database_call_entry.dart' as _i26;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i26.ReactiveDatabaseCallEntry) {
      return _i26.ReactiveDatabaseCallEntry.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i26.ReactiveDatabaseCallEntry?>()) {
      return (data != null
              ? _i26.ReactiveDatabaseCallEntry.fromJson(data)
              : null)
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i26.ReactiveDatabaseCallEntry => 'ReactiveDatabaseCallEntry',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i26.ReactiveDatabaseCallEntry():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ReactiveDatabaseCallEntry') {
      return deserialize<_i26.ReactiveDatabaseCallEntry>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    switch (t) {
      ...
      case _i26.ReactiveDatabaseCallEntry:
        return _i26.ReactiveDatabaseCallEntry.t;
      case _i27.ReadWriteTestEntry:
