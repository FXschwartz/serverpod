...
class ReactiveDatabaseCallEntryUpdateTable
  ...
  _i1.ColumnValue<String, String> futureCallName(String value) =>
      _i1.ColumnValue(
        table.futureCallName,
        value,
      );
...
class ReactiveDatabaseCallEntryTable extends _i1.Table<int?> {
  ReactiveDatabaseCallEntryTable({super.tableRelation})
    ...
    futureCallName = _i1.ColumnString(
      'futureCallName',
      this,
    );
  ...
  /// The name of the reactive future call to invoke.
  late final _i1.ColumnString futureCallName;
