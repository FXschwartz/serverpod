...
abstract interface class DatabaseProvider {
  ...
  /// Creates a new [ReactiveTriggerManager] for the given [database].
  ///
  /// Returns `null` if the database dialect does not support reactive triggers.
  ReactiveTriggerManager? createReactiveTriggerManager(Database database);
}
