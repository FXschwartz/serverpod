...
import 'reactive_database_call_entry.dart' as _i22;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i22.ReactiveDatabaseCallEntry) {
      return _i22.ReactiveDatabaseCallEntry.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i22.ReactiveDatabaseCallEntry?>()) {
      return (data != null
              ? _i22.ReactiveDatabaseCallEntry.fromJson(data)
              : null)
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i22.ReactiveDatabaseCallEntry => 'ReactiveDatabaseCallEntry',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i22.ReactiveDatabaseCallEntry():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ReactiveDatabaseCallEntry') {
      return deserialize<_i22.ReactiveDatabaseCallEntry>(data['data']);
    }
