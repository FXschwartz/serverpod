...
import 'reactive_database_call_entry.dart' as _i23;
...
import 'package:serverpod_database/src/generated/table_definition.dart' as _i34;
import 'package:serverpod_database/serverpod_database.dart' as _i35;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i23.ReactiveDatabaseCallEntry) {
      return _i23.ReactiveDatabaseCallEntry.fromJson(data) as T;
    }
    if (t == _i24.ReadWriteTestEntry) {
      return _i24.ReadWriteTestEntry.fromJson(data) as T;
    }
    if (t == _i25.RuntimeSettings) {
      return _i25.RuntimeSettings.fromJson(data) as T;
    }
    if (t == _i26.ServerHealthConnectionInfo) {
      return _i26.ServerHealthConnectionInfo.fromJson(data) as T;
    }
    if (t == _i27.ServerHealthMetric) {
      return _i27.ServerHealthMetric.fromJson(data) as T;
    }
    if (t == _i28.ServerHealthResult) {
      return _i28.ServerHealthResult.fromJson(data) as T;
    }
    if (t == _i29.ServerpodSqlException) {
      return _i29.ServerpodSqlException.fromJson(data) as T;
    }
    if (t == _i30.SessionLogEntry) {
      return _i30.SessionLogEntry.fromJson(data) as T;
    }
    if (t == _i31.SessionLogFilter) {
      return _i31.SessionLogFilter.fromJson(data) as T;
    }
    if (t == _i32.SessionLogInfo) {
      return _i32.SessionLogInfo.fromJson(data) as T;
    }
    if (t == _i33.SessionLogResult) {
      return _i33.SessionLogResult.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i23.ReactiveDatabaseCallEntry?>()) {
      return (data != null
              ? _i23.ReactiveDatabaseCallEntry.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i24.ReadWriteTestEntry?>()) {
      return (data != null ? _i24.ReadWriteTestEntry.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i25.RuntimeSettings?>()) {
      return (data != null ? _i25.RuntimeSettings.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i26.ServerHealthConnectionInfo?>()) {
      return (data != null
              ? _i26.ServerHealthConnectionInfo.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i27.ServerHealthMetric?>()) {
      return (data != null ? _i27.ServerHealthMetric.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i28.ServerHealthResult?>()) {
      return (data != null ? _i28.ServerHealthResult.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i29.ServerpodSqlException?>()) {
      return (data != null ? _i29.ServerpodSqlException.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i30.SessionLogEntry?>()) {
      return (data != null ? _i30.SessionLogEntry.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i31.SessionLogFilter?>()) {
      return (data != null ? _i31.SessionLogFilter.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i32.SessionLogInfo?>()) {
      return (data != null ? _i32.SessionLogInfo.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i33.SessionLogResult?>()) {
      return (data != null ? _i33.SessionLogResult.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i27.ServerHealthMetric>) {
      return (data as List)
              .map((e) => deserialize<_i27.ServerHealthMetric>(e))
              .toList()
          as T;
    }
    if (t == List<_i26.ServerHealthConnectionInfo>) {
      return (data as List)
              .map((e) => deserialize<_i26.ServerHealthConnectionInfo>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i32.SessionLogInfo>) {
      return (data as List)
              .map((e) => deserialize<_i32.SessionLogInfo>(e))
              .toList()
          as T;
    }
    if (t == List<_i34.TableDefinition>) {
      return (data as List)
              .map((e) => deserialize<_i34.TableDefinition>(e))
              .toList()
          as T;
    }
    if (t == List<String>) {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i23.ReactiveDatabaseCallEntry => 'ReactiveDatabaseCallEntry',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i23.ReactiveDatabaseCallEntry():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ReactiveDatabaseCallEntry') {
      return deserialize<_i23.ReactiveDatabaseCallEntry>(data['data']);
    }
