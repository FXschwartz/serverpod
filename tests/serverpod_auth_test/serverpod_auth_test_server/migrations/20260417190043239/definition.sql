...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_test', '20260417190043239', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417190043239', "timestamp" = now();
...
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_bridge', '20260417185953224', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417185953224', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_core
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_core', '20260417185936765', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417185936765', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_idp
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp', '20260417185944923', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417185944923', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_migration
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20260417190001453', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417190001453', "timestamp" = now();
