...
--
-- Foreign relations for "serverpod_reactive_db_call" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_test', '20260724160320942', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160320942', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod', '20260724160024146', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160024146', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_bridge
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_bridge', '20260724160158230', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160158230', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_core
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_core', '20260724160134801', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160134801', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_idp
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp', '20260724160146518', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160146518', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth_migration
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_migration', '20260724160210038', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160210038', "timestamp" = now();

--
-- MIGRATION VERSION FOR serverpod_auth
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth', '20260724160123295', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260724160123295', "timestamp" = now();
