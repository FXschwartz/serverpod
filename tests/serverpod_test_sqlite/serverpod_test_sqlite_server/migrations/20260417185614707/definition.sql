...
-- Indexes
CREATE INDEX "serverpod_reactive_db_call_unclaimed_idx" ON "serverpod_reactive_db_call" ("futureCallEntryId");
...
INSERT INTO "serverpod_sqlite_schema" VALUES
    ...
    ('serverpod_reactive_db_call', 'id', 'bigint', NULL),
    ('serverpod_reactive_db_call', 'futureCallName', 'text', NULL),
    ('serverpod_reactive_db_call', 'sourceTable', 'text', NULL),
    ('serverpod_reactive_db_call', 'operation', 'text', NULL),
    ('serverpod_reactive_db_call', 'rowData', 'text', NULL),
    ('serverpod_reactive_db_call', 'createdAt', 'timestampWithoutTimeZone', NULL),
    ('serverpod_reactive_db_call', 'futureCallEntryId', 'bigint', NULL),
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_test_sqlite', '20260417185614707', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260417185614707', "timestamp" = (unixepoch('now', 'subsecond') * 1000);

--
-- MIGRATION VERSION FOR serverpod
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod', '20260416201338962', (unixepoch('now', 'subsecond') * 1000))
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260416201338962', "timestamp" = (unixepoch('now', 'subsecond') * 1000);
